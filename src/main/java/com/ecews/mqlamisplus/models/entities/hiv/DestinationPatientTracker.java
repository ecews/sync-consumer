...
@DynamicInsert
public class DestinationPatientTracker extends HivAuditEntity implements Serializable, Persistable<Long> {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        DestinationPatientTracker that = (DestinationPatientTracker) o;
