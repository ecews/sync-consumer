...
public class DestinationArtClinical extends HivAuditEntity implements Serializable, Persistable<Long> {
    @Id
    ...
    @Column(name  = "hiv_enrollment_uuid", nullable = false, unique = true, updatable = false)
    private String hivEnrollment;
    ...
    @Column(name  = "vital_sign_uuid", nullable = false, unique = true, updatable = false)
